...
window.addEventListener('scroll', function () {
    window.scrollY < 400 ? header.classList.remove('invert') : (header.classList.add('invert'), document.body.getBoundingClientRect().top < scrollPos ? header.classList.add('hidden') : header.classList.remove('hidden')), scrollPos = document.body.getBoundingClientRect().top;
